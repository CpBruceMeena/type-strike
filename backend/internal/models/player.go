...
type Player struct {
	...
	LastClaimedDay      int        `json:"last_claimed_day" gorm:"column:last_claimed_day;default:0"`
	StreakFreezes       int        `json:"streak_freezes" gorm:"column:streak_freezes;default:0"`
	TotalDaysClaimed    int        `json:"total_days_claimed" gorm:"column:total_days_claimed;default:0"`
